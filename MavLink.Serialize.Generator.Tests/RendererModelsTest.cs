...
public class RendererModelsTest
{
    ...
    public void CheckCrc_WithExtensions()
    {
        ...
        {
            new MessageItemRenderModel("onboard_control_sensors_present",
                TypeRenderModel.CreateFromType("uint32_t", null), ""),
            new MessageItemRenderModel("onboard_control_sensors_enabled",
                TypeRenderModel.CreateFromType("uint32_t", null), ""),
            new MessageItemRenderModel("onboard_control_sensors_health",
                TypeRenderModel.CreateFromType("uint32_t", null), ""),
            ...
            new MessageItemRenderModel("onboard_control_sensors_present_extended",
                TypeRenderModel.CreateFromType("uint32_t", null), ""),
            new MessageItemRenderModel("onboard_control_sensors_enabled_extended",
                TypeRenderModel.CreateFromType("uint32_t", null), ""),
            new MessageItemRenderModel("onboard_control_sensors_health_extended",
                TypeRenderModel.CreateFromType("uint32_t", null), ""),
